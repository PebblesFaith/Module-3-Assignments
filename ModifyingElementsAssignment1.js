...
/*Create a variable list1 to store the ("span") document object element for deleting the "bad" word from the 
...
/*Create a variable list2 to store the ("span") document object element to add the "good" word to the paragraph (p)
  HTML webpage.*/
